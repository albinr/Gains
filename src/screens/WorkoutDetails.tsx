...
// import { useSaveSet, useSetsForExercise } from '../contexts/WorkoutDataContext';
...
//   const sets = useSetsForExercise(workoutId);
...
//       <Button mode='contained' style={{ width: '90%', maxWidth: 400 }} contentStyle={{ padding: 20 }} icon='check' onPress={() => saveSet({ reps, weight, exerciseId: workoutId })}>Save set</Button>
//       <VictoryChart>
//         <VictoryScatter
